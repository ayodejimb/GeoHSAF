...
splits_root = r"C:\.....\AIBL\After_matching\Splitted_triple"
...
for fold in folds:
    ...
    data_folder_CN = r'C:\.....\AIBL\After_matching\Splitted_triple\{}\{}_PCA_tangent_data'.format(fold, condis_train[0]) 
    data_folder_AD = r'C:\.....\AIBL\After_matching\Splitted_triple\{}\{}_PCA_tangent_data'.format(fold, condis_train[1])
    data_folder_MCI = r'C:\.....\AIBL\After_matching\Splitted_triple\{}\{}_PCA_tangent_data'.format(fold, condis_train[2])  

    data_folder_interp_CN_train = r'C:\.....\AIBL\After_matching\Splitted_triple\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_train[0]) 
    data_folder_interp_AD_train = r'C:\.....\AIBL\After_matching\Splitted_triple\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_train[1])
    data_folder_interp_MCI_train = r'C:\.....\AIBL\After_matching\Splitted_triple\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_train[2])  
    data_folder_interp_CN_test = r'C:\.....\AIBL\After_matching\Splitted_triple\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_test[0]) 
    data_folder_interp_AD_test = r'C:\.....\AIBL\After_matching\Splitted_triple\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_test[1])
    data_folder_interp_MCI_test = r'C:\.....\AIBL\After_matching\Splitted_triple\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_test[2])
    ...
    MCI_data_train = prepare_subject_data(subject_MCI_dict_train, label=2)
    all_data_train = CN_data_train + AD_data_train + MCI_data_train   # format is like this [[tensors of time_data], label], .... ]
    ...
    MCI_data_test = prepare_subject_data(subject_MCI_dict_test, label=2)
    ...
    def get_adaptive_scheduler(optimizer, warmup_steps, total_steps, pca_scale, base_lr=1e-4):
        scale_factor = max(pca_scale / 1e-3, 1e-4)
