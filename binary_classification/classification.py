...
for fold in folds:
    ...
    data_folder_CN = r'C:\.....\ADNI\After_matching\Splitted\{}\{}_PCA_tangent_data'.format(fold, condis_train[0]) 
    data_folder_AD = r'C:\.....\ADNI\After_matching\Splitted\{}\{}_PCA_tangent_data'.format(fold, condis_train[1]) 

    data_folder_interp_CN_train = r'C:\.....\ADNI\After_matching\Splitted\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_train[0]) 
    data_folder_interp_AD_train = r'C:\.....\ADNI\After_matching\Splitted\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_train[1]) 
    data_folder_interp_CN_test = r'C:\.....\ADNI\After_matching\Splitted\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_test[0]) 
    data_folder_interp_AD_test = r'C:\.....\ADNI\After_matching\Splitted\{}\{}_interpolated_PCA_tangent_data'.format(fold, condis_test[1])
    ...
    subject_AD_dict_test = load_interpolated_subject_time_series(data_folder_interp_AD_test, time_map_AD)   #values of this dict are also dict ({ID: {time: data}})
    ...
    def evaluate(model, dataloader, criterion):
        ...
        return avg_loss, accuracy, auc, total, correct
    ...
    for epoch in range(epochs):     
        ...
        test_loss, test_acc, test_auc, n_total, n_correct = evaluate(model, test_loader, criterion)
