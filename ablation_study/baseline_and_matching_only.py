...
for fold in folds:
    ...
    data_folder_CN_train = r'C:\....\ADNI\After_matching\Splitted\{}\{}_tangent_data'.format(fold, condis_train[0]) 
    data_folder_AD_train = r'C:\....\ADNI\After_matching\Splitted\{}\{}_tangent_data'.format(fold, condis_train[1]) 
    data_folder_CN_test = r'C:\....\ADNI\After_matching\Splitted\{}\{}_tangent_data'.format(fold, condis_test[0]) 
    data_folder_AD_test = r'C:\....\ADNI\After_matching\Splitted\{}\{}_tangent_data'.format(fold, condis_test[1])
