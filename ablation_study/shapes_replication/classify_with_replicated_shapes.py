...
for fold in folds:
    ...
    data_folder_interp_CN_train = r'C:\...\ADNI\After_matching\Splitted\{}\{}_false_interpolated_PCA_tangent_data'.format(fold, condis_train[0]) 
    data_folder_interp_AD_train = r'C:\...\ADNI\After_matching\Splitted\{}\{}_false_interpolated_PCA_tangent_data'.format(fold, condis_train[1]) 
    data_folder_interp_CN_test = r'C:\...\ADNI\After_matching\Splitted\{}\{}_false_interpolated_PCA_tangent_data'.format(fold, condis_test[0]) 
    data_folder_interp_AD_test = r'C:\...\ADNI\After_matching\Splitted\{}\{}_false_interpolated_PCA_tangent_data'.format(fold, condis_test[1])
    ...
    def compute_pca_scale(train_loader, num_batches=16):
        """Estimate scale of PCA inputs from a few batches."""
        vals = []
